    ...
    <div ref={aboutRef} className="about">
      ...
      >
        <Image
          ...
          width={530}
          height={530}
          className="about-image rounded-3xl shadow-2xl object-contain"
        />
        <motion.div
      ...
      >
        ...
        <motion.h4 variants={itemVariants} className="text-2xl font-semibold text-primary mb-6">
          Web & UI/UX Designer!
        </motion.h4>

        <motion.p variants={itemVariants} className="text-second-color text-lg leading-relaxed mb-8">
        ...
        >
          ...
          <motion.a
            ...
            className="btn bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-bg"
            whileHover={{ scale: 1.05, boxShadow: "0 10px 30px rgba(0, 255, 136, 0.4)" }}
            whileTap={{ scale: 0.95 }}
          >
            Download CV
